...
public class MyBST_670014 extends MyBST_Basic_670014 {
    ...
    public static void leftRotate(MyBST_XXYYYY bst, BNode node) {
    ...
    public static void rightRotate(MyBST_XXYYYY bst, BNode node) {
    ...
    public static void rightLeftRotate(MyBST_XXYYYY bst, BNode node) {
        if (node == null || node.right == null) return;
